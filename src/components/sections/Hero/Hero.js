        ...
        <div className={styles.hero__content}>
          ...
          <div className={styles.hero__main}>
            <h1 className={styles.hero__title}>
              ...
              <br />
              <span className={styles['hero__title--accent']}>AI-Driven Solutions.</span>
              <br />
            ...
            <p className={styles.hero__description}>
              Creating measurable operational value through innovation.
            </p>
          ...
          <div className={styles.hero__icons}>
            <div className={styles.hero__icon}>
              ...
              <span className={styles.icon__label}>AI & AUTOMATION</span>
            </div>
            ...
            <div className={styles.hero__icon}>
              ...
              <span className={styles.icon__label}>SMART SECURITY</span>
            </div>
            ...
            <div className={styles.hero__icon}>
              ...
              <span className={styles.icon__label}>INFRASTRUCTURE</span>
            </div>
          </div>
        </div>
      </div>
